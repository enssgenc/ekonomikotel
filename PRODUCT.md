...
## Stack
React with Vite, React Router, native CSS, Phosphor icons. Static Nginx deployment preserves the existing Coolify Dockerfile hosting arrangement.
...
2. Preserve supplier descriptions, identifiers and imagery.
3. Clearly distinguish catalogue browsing from a dated offer and a confirmed reservation.
4. Keep health tourism separate from holiday sales while allowing navigation between them.
5. Every displayed navigation item must have a working destination.
